<template>
	<div>
        ...
        <div v-for="item in res.Data" class="TabCon" :class="'floor'+item.IID" :key="item.IID" ref="myTabCon">
          <!-- 轮播类型 -->
          ...
          <!-- tab切换 -->
          <div v-else-if="item.ContentType==='7'" ref="subTab">
            <subTab :IData="item"></subTab>
          </div>
